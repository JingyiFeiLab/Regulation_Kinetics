...
dataset='/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/3_/output.txt';                                          % Name of the datafile that you input....Lot of output files will have this "dataset" in their names
%set "dic_file" to image containg the dic image

dic_file = '/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/3_/DIC_3_2d.tif';
dapi_file = '/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/3_/DAPI';
...
continuetranslation=1;
while continuetranslation==1
prompt={'X_Translation(- = Left, + = Right):','Y_Translation(- = Down, + = Up):','Continue the translation(1 == Yes && 0== NO) ?'};   % A box will take in the values for the X/Ytranslation
...
for i = 1:max(new_mask(:))
    ...
    cell_struct(i).Boundaries = bwboundaries(imerode(new_mask==i,se));
