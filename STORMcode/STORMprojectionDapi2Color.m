...
dataset='/Users/reyer/Data/STORM/seongjin72019/output_all.txt';                                          % Name of the datafile that you input....Lot of output files will have this "dataset" in their names
%set "dic_file" to image containg the dic image

dic_file = '/Users/reyer/Data/STORM/seongjin72019/DIC_3_crop.tif';
dapi_file = '/Users/reyer/Data/STORM/seongjin72019/rRNA_sample_3';
...
for i = 1:max(new_mask(:))
    ...
    for qt = 1:length(red_cell_spot_coords(:,1))
        ...
        spot_struct(red_cell_spot_coords(qt,1)).Collapsed_2D_Coordinate(1) = sign(spot_struct(red_cell_spot_coords(qt,1)).Transform_3D_Coordinate(1))*sqrt((double(spot_struct(red_cell_spot_coords(qt,1)).Transform_3D_Coordinate(1)))^2+(double(spot_struct(red_cell_spot_coords(qt,1)).Transform_3D_Coordinate(3)))^2);
    ...
    for gt = 1:length(green_cell_spot_coords(:,1))
        ...
        spot_struct(green_cell_spot_coords(gt,1)).Collapsed_2D_Coordinate(1) = sign(spot_struct(green_cell_spot_coords(gt,1)).Transform_3D_Coordinate(1))*sqrt((double(spot_struct(green_cell_spot_coords(gt,1)).Transform_3D_Coordinate(1)))^2+(double(spot_struct(green_cell_spot_coords(gt,1)).Transform_3D_Coordinate(3)))^2);
