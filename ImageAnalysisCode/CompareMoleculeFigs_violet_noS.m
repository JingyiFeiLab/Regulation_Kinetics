...
strain = {};
time = {};
Dates = {'November_28_2018'};
graph_title = ' rne701 asd1, no SgrS ';
...
if GFP == 1 && PTSG == 1 && sigma_check == 0
    ...
    for i = 1:length(strains)
        ...
        set(get(ax(2),'ylabel'),'string',ylabels{2})
        set(ax,{'ycolor'},{'g';'b'})
        set(ax(1),'YLim',[1.79E5 3.613E5])
        set(ax(2),'YLim',[5.15E6 1.280E7])
