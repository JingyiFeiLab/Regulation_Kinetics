function select_cells_4_new(coordinatefile,Columnx,Columny,Columnz,ColumnR,Column_No_Spots,ColorLineColumn,referenceimage,pixelscaling)
...
%******EXAMPLE OF USAGE
% select_cells_4_new('DJ480_0min_total_centers.dat',1,2,3,4,5,6,'film20.jpg',100);
% Where 
...
CellAnalysis=[CellAnalysis; [count length(find(ColumnCell==1)) length(find(ColumnCell==2)) length(find(ColumnCell==3)) length(find(ColumnCell==4)) ...
    Total_Numberof_Spots_1 Total_Numberof_Spots_2 Total_Numberof_Spots_3 Total_Numberof_Spots_4...
