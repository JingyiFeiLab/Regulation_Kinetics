folderTitle = '/Users/reyer/Data/SingleCellEpi/MR187/Fits41620/';

b_e = 2.4234e-04; %std = 2.23E-3
be_sd = 0.00004325619532;
a_m_plus_wt = 1;% std =589.18; 
amp_wt_sd = 0.1710477516;
a_m_plus_rne = 1; %std = 796.64
amp_rne_sd = 0.5705690142;
a_s_wt = 0.2822; %a_s = 2.29E+03;
a_s_wt_sd = 0.005953839098;
a_s_rne = 0.351325; %a_s = 2.29E+03; 
a_s_rne_sd = 0.01865347689;
b_s_wt = 1.46E-03; 
...
b_ms_rne = 0.0037; % b_ms = 4.88E-03;
b_ms_wt = 0.0037; % b_ms = 4.88E-03;
b_ms_sd = 0.001143780282;
b_p = .00018;
a_m_minus_wt = 3.5; %std = 310.41
amw_sd = 0.1173797257;
a_m_minus_rne = 2.4662; %std = 1164.1
amm_sd = 0.1979898987;
...
moleculeswt_plus = [((mean([molecules_wt_plus1(3,1),molecules_wt_plus2(3,1),molecules_wt_plus3(3,1)])+1.7582e+04)/7.8067e+03) mean(((([molecules_wt_plus1(2,1),molecules_wt_plus2(2,1),molecules_wt_plus3(2,1)])+4.3472e+04)/1.6831e+03)+1) 0 mean([molecules_wt_plus1(1,4),molecules_wt_plus2(1,4),molecules_wt_plus3(1,4)])];
...
moleculeswt_minus = [((mean([molecules_wt_minus1(3,1),molecules_wt_minus2(3,1)])+1.7582e+04)/7.8067e+03) mean(((([molecules_wt_minus1(2,1),molecules_wt_minus2(2,1)])+4.3472e+04)/1.6831e+03)+1) 0 mean([molecules_wt_minus1(1,4),molecules_wt_minus2(1,4)])];
...
std_wt_plus = [std((([molecules_wt_plus1(3,1),molecules_wt_plus2(3,1),molecules_wt_plus3(3,1)])+1.7582e+04)/7.8067e+03) std(((([molecules_wt_plus1(2,1),molecules_wt_plus2(2,1),molecules_wt_plus3(2,1)])+4.3472e+04)/1.6831e+03)+1) 0 std([molecules_wt_plus1(1,4),molecules_wt_plus2(1,4),molecules_wt_plus3(1,4)])];
...
std_wt_minus = [std((([molecules_wt_minus1(3,1),molecules_wt_minus2(3,1)])+1.7582e+04)/7.8067e+03) std(((([molecules_wt_minus1(2,1),molecules_wt_minus2(2,1)])+4.3472e+04)/1.6831e+03)+1) 0 std([molecules_wt_minus1(1,4),molecules_wt_minus2(1,4)])];
...
for i = 1:8
    ...
    molecules_wt_minus(3,i) = mean(((([molecules_wt_minus1(2,i),molecules_wt_minus2(2,i)])+4.3472e+04)/1.6831e+03)+1);
    ...
    molecules_wt_minus(4,i) = std(((([molecules_wt_minus1(2,i),molecules_wt_minus2(2,i)]+4.3472e+04)/1.6831e+03)+1))/1.414;
    ...
    molecules_wt_plus(5,i) = mean((([molecules_wt_plus1(3,i),molecules_wt_plus2(3,i),molecules_wt_plus3(3,i)])+1.7582e+04)/7.8067e+03);
    molecules_wt_minus(5,i) = mean((([molecules_wt_minus1(3,i),molecules_wt_minus2(3,i)])+1.7582e+04)/7.8067e+03);
    ...
    molecules_wt_minus(6,i) = std((([molecules_wt_minus1(3,i),molecules_wt_minus2(3,i)]+1.7582e+04)/7.8067e+03))/1.414;
